import { BudgetOverview } from '@financial-app/features/overview/native'
...
const meta = {
  title: 'Native/Features/Overview/BudgetOverview',
...
/** Overview mode — responsive layout based on window width. */
...
/** Budget page mode — spent amounts with Spending Summary. */
