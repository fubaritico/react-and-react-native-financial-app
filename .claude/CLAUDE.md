...
### Next — Phase 8A: App Wiring

**Current task**: Wire http-client into apps — auth gate + QueryClientProvider + HTTP client config
- Plan: `docs/plans/phase-8-api-and-http-client.md`
- Skill: `.claude/skills/api-openapi`

**Phase 8A pipeline**:
1. DB schema + seed + setup guide — ✅ Done (1aade95)
2. Scaffold `apps/api/` — ✅ Done (22f855d)
3. Zod schemas — ✅ Done (22f855d)
4. Routes — ✅ Done (22f855d)
5. OpenAPI spec generation + Swagger UI — ✅ Done (22f855d)
6. `packages/http-client/` — ✅ Done (94ab0bb)
7. TanStack Query hooks — ✅ Done (generated by HeyAPI react-query plugin)
