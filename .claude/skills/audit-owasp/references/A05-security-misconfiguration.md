...
OWASP Top 10 #5. Missing or incorrect security hardening across the application stack.

## Checklist

### Critical

#### OWASP-A05-001: Default credentials or demo accounts in production config
...
#### OWASP-A05-002: Overly permissive CORS
...
#### OWASP-A05-003: Verbose error messages in production
...
#### OWASP-A05-004: Security headers missing
...
#### OWASP-A05-005: Debug mode or dev tools in production
...
#### OWASP-A05-006: Unnecessary features enabled
...
#### OWASP-A05-007: Insecure default configurations
...
#### OWASP-A05-008: Missing environment variable validation
...
#### OWASP-A05-009: Directory listing enabled
...
#### OWASP-A05-010: Unnecessary HTTP methods
