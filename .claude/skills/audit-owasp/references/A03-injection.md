...
OWASP Top 10 #3. Untrusted data sent to an interpreter as part of a command or query.

## Checklist

### Critical

#### OWASP-A03-001: SQL injection via string interpolation
...
#### OWASP-A03-002: XSS via dangerouslySetInnerHTML
...
#### OWASP-A03-003: Command injection
...
#### OWASP-A03-004: XSS via unescaped user input in DOM
- **Where**: `.web.tsx` files
...
#### OWASP-A03-007: Header injection
...
#### OWASP-A03-009: Regex injection (ReDoS)
